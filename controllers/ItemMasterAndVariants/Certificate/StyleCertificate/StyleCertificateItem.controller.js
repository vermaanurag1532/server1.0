import ItemService from '../../../../Service/ItemMasterAndVariants/Certificate/StyleCertificate/StyleCertificateItem.service.js';
import { generateAndDownloadExcel } from '../../../../utils/excelUtils.js';

const StyleCertificateItemController = {
    ...
    downloadItemsExcel: async (req, res) => {
        try {
            ...
            const columns = [
                { header: 'Consumable Code', key: 'Consumable code', width: 20 },
...
export default StyleCertificateItemController;
